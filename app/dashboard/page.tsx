    ...
    return (
        <div className="p-6 max-w-4xl mx-auto space-y-6">
            <header className="border-b pb-4">
                <h1 className="text-3xl font-bold tracking-tight">Asset-Watch Workspace</h1>
            ...
            <main className="space-y-4">
              ...
              {hasSectionAccess(role, "MASTER_ROOT_CONTROL") && (
              ...
              {hasSectionAccess(role, "USER_MANAGEMENT") && (
              ...
              {hasSectionAccess(role, "DATA_FORENSICS") && (
